...
import AIResponsePreviewer from '../../pages/InterviewPrep/components/AIResponsePreviewer';
    ...
    <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group'>
        <div className='flex items-start justify-between cursor-pointer'>
            ...
            <div className='flex items-center justify-end ml-4 relative'>
                ...
                >
                    <button
                    className='flex items-center gap-2 text-xs text-indigo-800 font-medium bg-indigo-50 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-50 hover:border-indigo-300 cursor-pointer'
                    onClick={onTogglePin}
                    >
                        {isPinned?(
